...
$section1->addText("RESUMEN DE TRASPASO",array("size"=>22,"bold"=>true,"align"=>"right"));
...
$table2->addCell()->addText($symbol." ".number_format($product->price_out,2,".",","));
$table2->addCell()->addText($symbol." ".number_format($operation->q*$product->price_out,2,".",","));
...
$filename = "resumen de traspaso-".time().".docx";
