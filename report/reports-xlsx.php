...
$objPHPExcel->getProperties()->setCreator("FERRE-ELECTRICOS CORDERO C.A.")
							 ...
							 ->setTitle("Reportes - FERRE-ELECTRICOS CORDERO C.A.")
							 ->setSubject("FERRE-ELECTRICOS CORDERO C.A. Reportes")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
header('Content-Disposition: attachment;filename="reportes1-'.time().'.xlsx"');
