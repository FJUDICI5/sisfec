...
$table2->addCell()->addText("Bs".number_format($product->price_in,2,".",","));
$table2->addCell()->addText("Bs".number_format($operation->q*$product->price_in,2,".",","));
$total+=$operation->q*$product->price_in;
}

$section1->addText("");
$section1->addText("SubTotal: $symbol ".number_format(($total-$sell->discount)/(1 + ($iva_val/100) ),2,".",","),array("size"=>20));
$section1->addText("Impuesto: $symbol ".number_format(( ($total-$sell->discount)/(1 + ($iva_val/100) )) *($iva_val/100),2,'.',','),array("size"=>20));
$section1->addText("Total: $symbol ".number_format($total,2,".",","),array("size"=>20));
