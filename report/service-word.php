...
$section1->addText("");
$section1->addText("");
$section1->addText("COSTO TOTAL: BS ".number_format($total,2,".",","),array("size"=>18));
$section1->addText("<br><br>Edo. Trujillo, Municipio Valera, Parroquia Juan Ignacio Montilla, calle 12 entre avenidad 5 y 6.");


$filebase = "servicio-".time();
