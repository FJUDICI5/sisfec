...
$table1->addCell(2000)->addText("Bs". number_format(PaymentData::sumByClientId($client->val)->total,2,".",","));
$table1->addCell(2000)->addText("Bs". number_format(PaymentData::sumByClientId($total)->total,2,".",","));
...
$filename = "historial de pagos-".time().".docx";
