...
include "../core/modules/blog/model/TowData.php";
...
$tow =  TowData::getById($_GET["id"]);
$tows = AsignationData::getAllByTowId($_GET["id"]);

$kinds = KindData::getAll(); 
$statuses = StatusData::getAll(); 

$section1 = $word->AddSection();
$section1->addText("<table border=0><tr><td><img src='../logo.png' style='width:120px;'></td><td><h1 style='font-size:30px;'>HISTORIAL DE GRUA</h1><h2>GRUA: $tow->plate - $tow->name</h2></td></tr></table><br><br>");
//$section1->addText(,array("size"=>14,"align"=>"right"));
...
$section1->addText("<br>Valera calle 12 entre avenidas 5 y 6");

$filebase = "grua de historia-".time();
