...
$objPHPExcel->getProperties()->setCreator("FERRE-ELECTRICOS CORDERO C.A.")
							 ...
							 ->setTitle("Productos - FERRE-ELECTRICOS CORDERO C.A.")
							 ->setSubject("FERRE-ELECTRICOS CORDERO C.A. Productos Reporte")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
$sheet->setCellValue('A1', 'Historial de pagos - FERRE-ELECTRICOS CORDERO C.A.')
...
->setCellValue('B'.$start, "Bs". $product->val)
->setCellValue('C'.$start, "Bs". $total)
...
header('Content-Disposition: attachment;filename="historia de pagos-'.time().'.xlsx"');
