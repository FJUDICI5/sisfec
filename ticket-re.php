...
$pdf->setX(20);
$pdf->Cell(11,$off,  $currency." ".number_format($product->price_in,2,".",",") ,0,0,"R");
$pdf->setX(32);
$pdf->Cell(11,$off,  $currency." ".number_format($op->q*$product->price_in,2,".",",") ,0,0,"R");

//    ".."  ".number_format($op->q*$product->price_in,2,".",","));
$total += $op->q*$product->price_in;
$off+=6;
}
...
$pdf->setX(2);
$pdf->Cell(5,$off+48,"FACTURA: ".$sell->id.' - FECHA: '.$sell->created_at);
$pdf->setX(2);
