...
<tr >
	...
	<td><b>Bs <?php  $pt = $product->price_out*$p["q"]; $total +=$pt; echo number_format($pt,2,".",","); ?></b></td>
...
<tr>
	<td><p>Subtotal</p></td>
	<td><p><b>Bs <?php echo number_format($total*(1 - ($iva_val/100) ),2,'.',','); ?></b></p></td>
</tr>
<tr>
	<td><p><?php echo $iva_name." (".$iva_val."%) ";?></p></td>
	<td><p><b>Bs <?php echo number_format($total*($iva_val/100),2,'.',','); ?></b></p></td>
</tr>
<tr>
	<td><p>Total</p></td>
...
<script>
    ...
    if(p!=4){
		if(money<(<?php echo $total;?>-discount)){
			...
			go = confirm("Cambio: Bs"+(money-(<?php echo $total;?>-discount ) ) );
			if(go){}
