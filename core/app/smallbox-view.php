...
<div class="input-group">
  ...
  <input type="text" class="form-control"  placeholder="Monto Bs" name="amount">
</div>
  </div>
...
<div class="input-group">
  <span class="input-group-addon">Bs</span>
  <input type="text" class="form-control" value="<?php echo $x->amount;?>"  placeholder="Monto Bs" name="amount">
</div>
  </div>
