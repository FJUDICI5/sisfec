...
<li><a onclick="thePDF()" id="makepdf" class="">PDF (.pdf)</a></li>
		...
		<h1><i class='glyphicon glyphicon-shopping-cart'></i> Compras Canceladas</h1>
<?php endif;?>
...
<table class="table table-bordered table-hover table-responsive datatable	">
	...
	<tr>
		<td style="width:30px;">
		<a href="index.php?view=onere&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open"></i></a></td>
...
<?php if(isset($_SESSION["user_id"])):?>
		<a href="index.php?action=uncancelre&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-info">Restaurar</a>
