...
<tr>
	...
	<td>Bs <?php echo number_format($product->price_out,2,".",",") ;?></td>
	<td><b>Bs <?php echo number_format($operation->q*$product->price_out,2,".",",");
...
<br><br><h1>Total: Bs <?php echo number_format($total,2,'.',','); ?></h1>
	<?php
