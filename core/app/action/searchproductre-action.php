...
<div class="input-group">
  ...
  <input type="text" class="form-control" name="price_in" placeholder="Bs Entrada" value="<?php echo $product->price_in; ?>">
</div>
</div>
		<div class="col-md-3">
...
<div class="input-group">
  <span class="input-group-addon"><?php echo Core::$symbol; ?></span>
  <input type="text" class="form-control" name="price_out" placeholder="Bs Salida" value="<?php echo $product->price_out; ?>">
</div>
</div>
		<div class="col-md-3">
