...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SIS FEC C.A. | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>SIS</b>FEC</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">SIS<b>FEC C.A.</b></span>
        </a>
   ...
   <?php endif; ?>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2023 TSU Judici Frank, Lissette Ramirez</a></strong>
      </footer>
      <?php else:?>
        <?php if(isset($_GET["view"]) && $_GET["view"]=="clientaccess"):?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">SIS<b>FEC C.A.</b></a>
      </div><!-- /.login-logo -->
