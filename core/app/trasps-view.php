...
<li><a onclick="thePDF()" id="makepdf" class="">PDF (.pdf)</a></li>
		...
		<h1><i class='glyphicon glyphicon-shopping-cart'></i> Traspasos</h1>
<?php endif;?>
...
<h3 class="box-title">Traspasos</h3></div>
<div class="box-body">
<table class="table table-bordered table-hover table-responsive datatable	">
	...
	<tr>
		<td style="width:30px;">
		<a href="index.php?view=onetraspase&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-eye-open"></i></a></td>
...
<!--
		...
		-->
		<a href="index.php?view=deltrasp&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i><a>
<?php endif;?>
		</td>
	</tr>
